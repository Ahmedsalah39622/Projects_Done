...
Public Class Frm_balnceSheet2024
    Dim oldDate As Date
    ...
    End Sub
    Sub cerate_Balnce_level()
        Dim varlevl As Integer
        If RadioButton1.Checked = True Then varlevl = 1
        If RadioButton2.Checked = True Then varlevl = 2
        If RadioButton3.Checked = True Then varlevl = 3
        If RadioButton4.Checked = True Then varlevl = 4



        sql = " DROP VIEW dbo.BalanceSheet2024"
        rs = Cnn.Execute(sql)

        sql2 = " CREATE VIEW BalanceSheet2024 AS  SELECT TOP (100) PERCENT 'الأصول طويلة الأجل' AS NameBand1, RTRIM(ST_CHARTOFACCOUNT_1.AccountName) AS NameBand, dbo.Vw_TralBalanceall_LAll.acc, dbo.Vw_TralBalanceall_LAll.AccountName, dbo.Vw_TralBalanceall_LAll.DebitSum, " & _
                  "                  dbo.Vw_TralBalanceall_LAll.CriditSum, dbo.Vw_TralBalanceall_LAll.DebitSum - dbo.Vw_TralBalanceall_LAll.CriditSum AS Total_, dbo.Vw_TralBalanceall_LAll.AccountPh " & _
                  ...
                  "            WHERE(dbo.Vw_TralBalanceall_LAll.AccountType = 1) " & _
                  ...
                  "            dbo.Vw_TralBalanceall_LAll.lev, dbo.Vw_TralBalanceall_LAll.AccountPh " & _
                  " HAVING (dbo.Vw_TralBalanceall_LAll.lev = '" & varlevl & "') AND (dbo.Vw_TralBalanceall_LAll.AccountPh = 0) " & _
                  "  "
        rs = Cnn.Execute(sql2)
        ...
        '======================================
        sql = " DROP VIEW dbo.BalanceSheet2024_2"
        rs = Cnn.Execute(sql)


        sql2 = " CREATE VIEW BalanceSheet2024_2 AS SELECT TOP (100) PERCENT 'الإلتزامات طويلة الأجل' AS NameBand1, RTRIM(ST_CHARTOFACCOUNT_1.AccountName) AS NameBand, dbo.Vw_TralBalanceall_LAll.acc, dbo.Vw_TralBalanceall_LAll.AccountName, dbo.Vw_TralBalanceall_LAll.DebitSum,  " & _
"                  dbo.Vw_TralBalanceall_LAll.CriditSum, dbo.Vw_TralBalanceall_LAll.DebitSum - dbo.Vw_TralBalanceall_LAll.CriditSum AS Total_, dbo.Vw_TralBalanceall_LAll.AccountPh " & _
" FROM     dbo.ST_CHARTOFACCOUNT AS ST_CHARTOFACCOUNT_1 LEFT OUTER JOIN " & _
"                  dbo.ST_CHARTOFACCOUNT ON ST_CHARTOFACCOUNT_1.Account_No = dbo.ST_CHARTOFACCOUNT.Level_No2 LEFT OUTER JOIN " & _
"                  dbo.Vw_TralBalanceall_LAll ON dbo.ST_CHARTOFACCOUNT.Account_No = dbo.Vw_TralBalanceall_LAll.acc " & _
...
" GROUP BY RTRIM(ST_CHARTOFACCOUNT_1.AccountName), dbo.Vw_TralBalanceall_LAll.acc, dbo.Vw_TralBalanceall_LAll.AccountName, dbo.Vw_TralBalanceall_LAll.DebitSum, dbo.Vw_TralBalanceall_LAll.CriditSum, " & _
"            dbo.Vw_TralBalanceall_LAll.lev, dbo.Vw_TralBalanceall_LAll.AccountPh " & _
" HAVING (dbo.Vw_TralBalanceall_LAll.lev = '" & varlevl & "') AND (dbo.Vw_TralBalanceall_LAll.AccountPh = 1) " & _
"  "
        rs = Cnn.Execute(sql2)
    End Sub
    Sub find_data()
        ...
        sql2 = "select NameBand1, NameBand, acc, AccountName, Total_  from  BalanceSheet2024_ALL  "
        Cnn.Execute(sql2)
        ...
        GridView1.Columns(4).Caption = "القيمة"
    ...
    Private Sub SimpleButton1_Click_4(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        Dim report As New BalanceSheet2024   '
        'sum_Incomestatment()
