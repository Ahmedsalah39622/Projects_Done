...
Public Class Azn_Stores_M2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Azn_Stores_M2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAzn_Stores_M2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Azn_Stores_M2 = New Azn_Stores_M2()
        rpt.Site = Me.Site
        Return rpt
    End Function
