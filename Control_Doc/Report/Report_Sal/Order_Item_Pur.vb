...
Public Class Order_Item_Pur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Order_Item_Pur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrder_Item_Pur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Order_Item_Pur = New Order_Item_Pur()
        rpt.Site = Me.Site
        Return rpt
    End Function
