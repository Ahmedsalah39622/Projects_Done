...
Public Class InvintoryValue1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.InvintoryValue1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvintoryValue1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvintoryValue1 = New InvintoryValue1()
        rpt.Site = Me.Site
        Return rpt
    End Function
