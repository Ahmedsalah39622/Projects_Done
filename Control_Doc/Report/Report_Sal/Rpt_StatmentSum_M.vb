...
Public Class Rpt_StatmentSum_M
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_StatmentSum_M.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StatmentSum_M
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StatmentSum_M = New Rpt_StatmentSum_M()
        rpt.Site = Me.Site
        Return rpt
    End Function
