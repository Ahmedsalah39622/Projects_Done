...
Public Class Expenses_Report_M2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Expenses_Report_M2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpenses_Report_M2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Expenses_Report_M2 = New Expenses_Report_M2()
        rpt.Site = Me.Site
        Return rpt
    End Function
