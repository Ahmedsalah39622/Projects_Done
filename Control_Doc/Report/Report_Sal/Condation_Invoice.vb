...
Public Class Condation_Invoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Condation_Invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCondation_Invoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Condation_Invoice = New Condation_Invoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
