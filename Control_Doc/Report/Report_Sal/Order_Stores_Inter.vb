...
Public Class Order_Stores_Inter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Order_Stores_Inter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrder_Stores_Inter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Order_Stores_Inter = New Order_Stores_Inter()
        rpt.Site = Me.Site
        Return rpt
    End Function
