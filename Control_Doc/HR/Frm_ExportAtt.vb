    ...
    Private Sub SimpleButton14_Click_1(sender As Object, e As EventArgs) Handles SimpleButton14.Click
        ...
        If OP1.Checked = True Then
            ...
            For rowHandle As Integer = 0 To GridView1.DataRowCount - 1
                ...
                'sql = "INSERT INTO BD_GROUPITEMMAIN (code,Name, Compny_Code) " & _
                ...
                Dim dd As DateTime = Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(1)))
                Dim vardateoder As String
                vardateoder = dd.ToString("MM/dd/yyyy")

                Dim dd2 As DateTime = Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(1)))
                Dim vardateoder2 As String
                vardateoder2 = dd2.ToString("hh:mm:ss tt", CultureInfo.CreateSpecificCulture("en-us"))
                ...
                sql2 = "INSERT INTO Tb_Emplast2 (Code, Date_User,TimeData) " & _
                     " values  ('" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(0))) & "' ,'" & vardateoder & "','" & vardateoder2 & "')"
                rs = Cnn.Execute(sql2)
        ...
        '        sql = "INSERT INTO BD_GroupItem1 (code,Name, Compny_Code) " & _
        '          " values  ('" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(0))) & "' ,'" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(1))) & "' ,'" & VarCodeCompny & "')"
        '        Cnn.Execute(sql)
        ...
        '        sql = "select * from BD_GroupItem2 where Code = '" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(0))) & "' "
        '        rs2 = Cnn.Execute(sql)
        '        If rs2.EOF = False Then MsgBox("الكود مكرر لايمكن ادخاله ", MsgBoxStyle.Critical, "Css") : Exit Sub


        '        sql = "INSERT INTO BD_GroupItem2 (code,Name, Compny_Code) " & _
        '          " values  ('" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(0))) & "' ,'" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(1))) & "' ,'" & VarCodeCompny & "')"
        '        Cnn.Execute(sql)
        ...
        '        sql = "INSERT INTO BD_Item (Code,Compny_Code, Ex_Item,Name,CodeGroupItemMain,CodeGroupItem1,CodeGroupItem2,Unit1,PriceSal,PricePrcheses) " & _
        '          " values  (N'" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(0))) & "' ,N'" & VarCodeCompny & "' ,N'" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(2))) & "',N'" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(3))) & "',N'" & varGM & "',N'" & varG1 & "',N'" & varG2 & "',N'" & 2 & "',N'" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(8))) & "',N'" & Trim(GridView1.GetRowCellValue(rowHandle, GridView1.Columns(9))) & "')"
        '        Cnn.Execute(sql)
