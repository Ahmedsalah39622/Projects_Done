...
Public Class Frm_Vaction
    ...
    Sub Find_all()
        ...
        sql = "SELECT        dbo.Vw_Vaction1.Code_Move, dbo.Vw_Vaction1.Name, dbo.Vw_Vaction1.NameDeprt, dbo.Vw_Vaction1.NameJopName, dbo.Vw_Vaction1.Emp_Name, dbo.Vw_Vaction1.DateIn, dbo.vw_vaction2.DateIn AS DateOut, " & _
"                         dbo.Vw_Vaction1.NameVaction,DATEDIFF(day,  dbo.Vw_Vaction1.DateIn,  dbo.vw_vaction2.DateIn) AS DateDiff " & _
" FROM            dbo.Vw_Vaction1 INNER JOIN " & _
"                         dbo.vw_vaction2 ON dbo.Vw_Vaction1.Code_Move = dbo.vw_vaction2.Code_Move AND dbo.Vw_Vaction1.Compny_Code = dbo.vw_vaction2.Compny_Code " & _
"        WHERE(dbo.Vw_Vaction1.Compny_Code = '" & VarCodeCompny & "') "
        ...
        GridView2.Columns(7).Caption = "نوع الاجازة"
        GridView2.Columns(8).Caption = "المدة"
  ...
  " HAVING        (dbo.BD_DIRCTORAY.Name like '%" & Com_Dir.Text & "%') AND (dbo.BD_DIRCTORAY.Compny_Code = '" & VarCodeCompny & "') AND (dbo.BD_DEPARTMENTS.Name like '%" & Com_Deprt.Text & "%')  AND (dbo.BD_JOBNAMES.Name like '%" & Com_JopName.Text & "%') "
    ...
    Sub last_Data()
        ...
        sql = "  SELECT        MAX(Code_Move) AS MaxMaim,Compny_Code FROM            Seting_Vaction    GROUP BY Compny_Code  HAVING        (MAX(Code_Move) IS NOT NULL) and (Compny_Code = '" & VarCodeCompny & "')  "
        rs = Cnn.Execute(sql)
    ...
    Private Sub Com_Vaction_ButtonClick(sender As Object, e As XtraEditors.Controls.ButtonPressedEventArgs) Handles Com_Vaction.ButtonClick
    ...
    Private Sub Com_JopName_Click(sender As Object, e As EventArgs) Handles Com_JopName.Click
    ...
    Private Sub cmd_save_Click(sender As Object, e As EventArgs) Handles cmd_save.Click
        ...
        If Len(Com_Vaction.Text) = 0 Then MsgBox("من فضلك ادخل نوع الاجازة ", MsgBoxStyle.Critical + MsgBoxStyle.MsgBoxRtlReading, "Css Solution Software Module") : Exit Sub
    ...
    Sub add_payment()
        ...
        If oldDay = 0 Then oldDay = oldDay + 1
        ...
        If vardayrent = vardayrent2 Then oldDay = oldDay - 1
        If vardayrent <> vardayrent2 Then oldDay = oldDay - 1
        ...
        'If oldDay = 1 Then CurrD = CurrD + 1
        While (CurrD < endP)
            'ProcessData(CurrD)
            Console.WriteLine(CurrD.ToShortDateString)

            'If oldDay = 1 Then
            '    CurrD = CurrD.AddDays(0)
            'Else
            ...
            '==================================================نوع الاجازة 
            sql2 = "  SELECT *    FROM BD_Vaction where   Name ='" & Com_Vaction.Text & "' and Compny_Code ='" & VarCodeCompny & "'  "
            rs2 = Cnn.Execute(sql2)
            If rs2.EOF = False Then Varcode_Vaction = rs2("Code").Value
            '=================================================بدايةالفترة
            ...
            sql = "INSERT INTO Seting_Vaction (Code_Move, Date_From,code_dir,code_deprt,code_jop,emp_code,vaction_Code,Compny_Code) " & _
            " values  ('" & com_Code.Text & "' ,'" & vardayrent3 & "','" & VarcodeDir & "','" & Varcodedeprt & "','" & varcode_jop & "','" & Varcode_emp & "','" & Varcode_Vaction & "','" & VarCodeCompny & "' )"
            Cnn.Execute(sql)
    ...
    Sub find_data()
        sql = "SELECT        dbo.Vw_Vaction1.Code_Move, dbo.Vw_Vaction1.Name, dbo.Vw_Vaction1.NameDeprt, dbo.Vw_Vaction1.NameJopName, dbo.Vw_Vaction1.Emp_Name, dbo.Vw_Vaction1.DateIn, dbo.vw_vaction2.DateIn AS DateOut, " & _
            "                         dbo.Vw_Vaction1.NameVaction " & _
            " FROM            dbo.Vw_Vaction1 INNER JOIN " & _
            "                         dbo.vw_vaction2 ON dbo.Vw_Vaction1.Code_Move = dbo.vw_vaction2.Code_Move AND dbo.Vw_Vaction1.Compny_Code = dbo.vw_vaction2.Compny_Code " & _
            "        WHERE(dbo.Vw_Vaction1.Compny_Code = '" & VarCodeCompny & "') and Vw_Vaction1.Code_Move ='" & com_Code.Text & "'  "
        ...
        GridView1.Columns(7).Caption = "نوع الاجازة"
    ...
    Sub fill_data()
        ...
        sql = "SELECT        Vw_Vaction1.Code_Move,dbo.Vw_Vaction1.Code_Move, dbo.Vw_Vaction1.Name, dbo.Vw_Vaction1.NameDeprt, dbo.Vw_Vaction1.NameJopName, dbo.Vw_Vaction1.Emp_Name, dbo.Vw_Vaction1.DateIn, dbo.vw_vaction2.DateIn AS DateOut, " & _
    "                         dbo.Vw_Vaction1.NameVaction " & _
    " FROM            dbo.Vw_Vaction1 INNER JOIN " & _
    "                         dbo.vw_vaction2 ON dbo.Vw_Vaction1.Code_Move = dbo.vw_vaction2.Code_Move AND dbo.Vw_Vaction1.Compny_Code = dbo.vw_vaction2.Compny_Code " & _
    "        WHERE(dbo.Vw_Vaction1.Compny_Code = '" & VarCodeCompny & "') and Vw_Vaction1.Code_Move ='" & value2 & "'  "
        rs = Cnn.Execute(sql)
        If rs.EOF = False Then
    ...
    Private Sub Cmd_Delete_Click(sender As Object, e As EventArgs) Handles Cmd_Delete.Click
        ...
        Select Case x
            ...
            Case vbYes
                sql = "Delete Seting_Vaction  WHERE Code_Move = " & com_Code.Text & " and Compny_Code ='" & VarCodeCompny & "' "
                rs = Cnn.Execute(sql)
    ...
    Private Sub Com_Vaction_EditValueChanged(sender As Object, e As EventArgs) Handles Com_Vaction.EditValueChanged
