...
Public Class Rpt_StatmentSum_F
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_StatmentSum_F.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StatmentSum_F
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StatmentSum_F = New Rpt_StatmentSum_F()
        rpt.Site = Me.Site
        Return rpt
    End Function
