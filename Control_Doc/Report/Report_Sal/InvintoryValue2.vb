...
Public Class InvintoryValue2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.InvintoryValue2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvintoryValue2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvintoryValue2 = New InvintoryValue2()
        rpt.Site = Me.Site
        Return rpt
    End Function
