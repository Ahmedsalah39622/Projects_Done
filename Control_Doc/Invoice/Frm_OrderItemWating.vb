...
Public Class Frm_OrderItemWating
...
"                  AS Ex_Item, dbo.BD_ITEM.Name AS NameItem, dbo.TB_Detils_OrderItem.Quntity, dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO " & _
...
"                    dbo.TB_Detils_OrderItem_Stores ON dbo.TB_Detils_OrderItem.Compny_Code = dbo.TB_Detils_OrderItem_Stores.Compny_Code AND  " & _
"        dbo.TB_Detils_OrderItem.Ex_Item = dbo.TB_Detils_OrderItem_Stores.Ex_Item And dbo.TB_Detils_OrderItem.Order_NO = dbo.TB_Detils_OrderItem_Stores.Order_NO " & _
...
"        dbo.TB_Detils_OrderItem.Quntity, dbo.BD_ITEM.Name, dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO " & _
"        HAVING(dbo.TB_Detils_OrderItem.Flag_Item = 1) "
        ...
        If Op2.Checked = True Then
           ...
           "                  AS Ex_Item, dbo.BD_ITEM.Name AS NameItem, dbo.TB_Detils_OrderItem.Quntity, dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO " & _
            ...
            " GROUP BY dbo.TB_Header_OrderItem.Order_NO, dbo.TB_Header_OrderItem.Order_Date, dbo.TB_Detils_OrderItem.Flag_Item, dbo.FindCustomer.Name, dbo.Emp_employees.Emp_Name, dbo.TB_Detils_OrderItem.Ex_Item,  " & _
            "        dbo.TB_Detils_OrderItem.Quntity, dbo.BD_ITEM.Name, dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO " & _
            "        HAVING(dbo.TB_Detils_OrderItem.Flag_Item = 1) AND (dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO IS NULL) "
        End If
        ...
        If Op1.Checked = True Then
           ...
           "                  AS Ex_Item, dbo.BD_ITEM.Name AS NameItem, dbo.TB_Detils_OrderItem.Quntity, dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO " & _
            ...
            " GROUP BY dbo.TB_Header_OrderItem.Order_NO, dbo.TB_Header_OrderItem.Order_Date, dbo.TB_Detils_OrderItem.Flag_Item, dbo.FindCustomer.Name, dbo.Emp_employees.Emp_Name, dbo.TB_Detils_OrderItem.Ex_Item,  " & _
            "        dbo.TB_Detils_OrderItem.Quntity, dbo.BD_ITEM.Name, dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO " & _
            "        HAVING(dbo.TB_Detils_OrderItem.Flag_Item = 1) AND (dbo.TB_Detils_OrderItem_Stores.Order_Stores_NO IS NOT NULL) "
    ...
    Sub Save_DetilsOrderItem_Stores()
        ...
        Do While Not rs.EOF
            ...
            sql = "INSERT INTO TB_Detils_OrderItem_Stores (Order_Stores_NO,Ex_Item, No_Item,Quntity,Code_Unit,Compny_Code,Flag_Item,Order_NO,Ser_Order_Stores) " & _
    ...
    Private Sub Cmd_CreateOrder_Click(sender As Object, e As EventArgs) Handles Cmd_CreateOrder.Click
        ...
        Frm_OrderItem_old.last_Data()

        Frm_OrderItem_old.MdiParent = Mainmune
        Frm_OrderItem_old.Show()
    End Sub
