...
Public Class Frm_Report_Procurement
    ...
    ' Private Sub txt_Region_CustomDisplayText(sender As Object, e As XtraEditors.Controls.CustomDisplayTextEventArgs) Handles txt_Region.CustomDisplayText

    ' End Sub

    ' Private Sub txt_Region_EditValueChanged(sender As Object, e As EventArgs) Handles txt_Region.EditValueChanged
    ...
    '     ButtonItem9.ForeColor = Color.Blue
    '     ButtonItem9.FontBold = True
    ' End Sub
    ...
    ' Private Sub Radio_Stop_CheckedChanged(sender As Object, e As EventArgs)
    ...
    Private Sub ButtonItem7_Click(sender As Object, e As EventArgs) Handles ButtonItem7.Click
        RelatedItemsWithSupplier()
    End Sub
    Sub RelatedItemsWithSupplier()
        'On Error Resume Next
        'GridControl3.DataSource = NullValue
        GridControl3.DataSource = Nothing
        'GridControl3.Refresh()
