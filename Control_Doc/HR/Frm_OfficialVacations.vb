...
Public Class Frm_OfficialVacations
    ...
    Private Sub SplitContainerControl4_Panel1_Paint(sender As Object, e As PaintEventArgs) Handles SplitContainerControl4.Panel1.Paint
    ...
    Private Sub txt_date_ValueChanged(sender As Object, e As EventArgs)
    ...
    Private Sub ButtonEdit6_EditValueChanged(sender As Object, e As EventArgs) Handles ButtonEdit6.EditValueChanged
