...
Public Class Estlam_Stores_F
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Estlam_Stores_F.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstlam_Stores_F
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estlam_Stores_F = New Estlam_Stores_F()
        rpt.Site = Me.Site
        Return rpt
    End Function
