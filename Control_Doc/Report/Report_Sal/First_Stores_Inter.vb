...
Public Class First_Stores_Inter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.First_Stores_Inter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFirst_Stores_Inter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As First_Stores_Inter = New First_Stores_Inter()
        rpt.Site = Me.Site
        Return rpt
    End Function
