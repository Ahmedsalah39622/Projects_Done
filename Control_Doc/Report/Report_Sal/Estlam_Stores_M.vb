...
Public Class Estlam_Stores_M
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Estlam_Stores_M.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstlam_Stores_M
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estlam_Stores_M = New Estlam_Stores_M()
        rpt.Site = Me.Site
        Return rpt
    End Function
