...
Public Class Expenses_Report_F
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Expenses_Report_F.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpenses_Report_F
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Expenses_Report_F = New Expenses_Report_F()
        rpt.Site = Me.Site
        Return rpt
    End Function
