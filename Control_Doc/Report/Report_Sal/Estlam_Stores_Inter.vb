...
Public Class Estlam_Stores_Inter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Estlam_Stores_Inter.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Estlam_Stores_Inter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstlam_Stores_Inter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estlam_Stores_Inter = New Estlam_Stores_Inter()
        rpt.Site = Me.Site
        Return rpt
    End Function
