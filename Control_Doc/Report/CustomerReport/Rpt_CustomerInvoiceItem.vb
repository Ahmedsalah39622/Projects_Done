...
Public Class Rpt_CustomerInvoiceItem
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_CustomerInvoiceItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_CustomerInvoiceItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CustomerInvoiceItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CustomerInvoiceItem = New Rpt_CustomerInvoiceItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
