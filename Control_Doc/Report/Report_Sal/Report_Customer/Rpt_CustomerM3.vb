...
Public Class Rpt_CustomerM3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_CustomerM3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CustomerM3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CustomerM3 = New Rpt_CustomerM3()
        rpt.Site = Me.Site
        Return rpt
    End Function
