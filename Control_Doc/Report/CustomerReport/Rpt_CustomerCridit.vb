...
Public Class Rpt_CustomerCridit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_CustomerCridit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CustomerCridit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CustomerCridit = New Rpt_CustomerCridit()
        rpt.Site = Me.Site
        Return rpt
    End Function
