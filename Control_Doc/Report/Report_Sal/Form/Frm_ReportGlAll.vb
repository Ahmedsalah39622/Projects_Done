...
Public Class Frm_ReportGlAll

    Private Sub Frm_ReportGlAll_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If VarCodeCompny = 1 Then cryRpt.Load(Path2 + "GL_Inter.rpt")
        If VarCodeCompny = 3 Then cryRpt.Load(Path2 + "GL_F.rpt")
        If VarCodeCompny = 2 Then cryRpt.Load(Path2 + "GL_M.rpt")
        ...
        cryRpt.DataDefinition.RecordSelectionFormula = "   {Vw_All_GL_Data.Compny_Code} = " & VarCodeCompny & " "
