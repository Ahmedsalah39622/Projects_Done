...
Public Class Rpt_Statment_Inter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_Statment_Inter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Statment_Inter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Statment_Inter = New Rpt_Statment_Inter()
        rpt.Site = Me.Site
        Return rpt
    End Function
