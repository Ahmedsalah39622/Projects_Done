...
Public Class Expenses_Report_M
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Expenses_Report_M.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExpenses_Report_M
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Expenses_Report_M = New Expenses_Report_M()
        rpt.Site = Me.Site
        Return rpt
    End Function
