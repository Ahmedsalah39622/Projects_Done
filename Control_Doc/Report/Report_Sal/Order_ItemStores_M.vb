...
Public Class Order_ItemStores_M
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Order_ItemStores_M.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrder_ItemStores_M
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Order_ItemStores_M = New Order_ItemStores_M()
        rpt.Site = Me.Site
        Return rpt
    End Function
