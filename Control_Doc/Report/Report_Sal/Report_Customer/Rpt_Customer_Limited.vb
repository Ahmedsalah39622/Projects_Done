...
Public Class Rpt_Customer_Limited
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_Customer_Limited.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_Customer_Limited.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ImageID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_Customer_Limited
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Customer_Limited = New Rpt_Customer_Limited()
        rpt.Site = Me.Site
        Return rpt
    End Function
