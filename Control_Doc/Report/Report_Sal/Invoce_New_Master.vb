...
Public Class Invoce_New_Master
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Invoce_New_Master.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoce_New_Master
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Invoce_New_Master = New Invoce_New_Master()
        rpt.Site = Me.Site
        Return rpt
    End Function
