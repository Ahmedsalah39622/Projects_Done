...
Public Class Frm_ChartOfAccount
    ...
    Sub select_Tree()
        ...
        End If
        If varlevel = 4 Then txt_AccountNo2.Visible = False : txt_NameAccount2.Visible = False : LabelX1.Visible = False Else txt_AccountNo2.Visible = True : txt_NameAccount2.Visible = True : LabelX1.Visible = True
        '==========================================================
    ...
    Sub find_tree()
        ...
        Do While Not rs.EOF
            ...
            If rs("Level_No").Value = 2 Then Data.Rows.Add(rs("Account_No").Value, Trim(rs("AccountNo_Name").Value) + "-" + Trim(rs("Account_No").Value), rs("Level_No2").Value) 'المستوى الثانى
            If rs("Level_No").Value = 3 Then Data.Rows.Add(rs("Account_No").Value, Trim(rs("AccountNo_Name").Value) + "-" + Trim(rs("Account_No").Value), rs("Level_No2").Value) 'المستوى الثانى
    ...
    Private Sub Frm_ChartOfAccount_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DB_InterpakDataSet1.vw_treelist' table. You can move, or remove it, as needed.
        'Me.Vw_treelistTableAdapter.Fill(Me.DB_InterpakDataSet1.vw_treelist)
        'TODO: This line of code loads data into the 'DB_InterpakDataSet4.vw_treelist' table. You can move, or remove it, as needed.
        'Me.Vw_treelistTableAdapter.Fill(Me.DB_InterpakDataSet4.vw_treelist)
        'TODO: This line of code loads data into the 'DB_InterpakDataSet3.vw_treelist' table. You can move, or remove it, as needed.
        'Me.Vw_treelistTableAdapter.Fill(Me.DB_InterpakDataSet3.vw_treelist)
        'TODO: This line of code loads data into the 'DB_InterpakDataSet.vw_AccountData' table. You can move, or remove it, as needed.

   



        'Dim node As TreeListNode = TreeList1.Nodes(1)
        'get all nodes whose caption has "R&D" in it 
        'Dim nodes = TreeList1.Nodes.Where(Function(n) n.GetDisplayText("NameLevel1").Contains("R&D"))


        'Dim node As TreeListNode = TreeList1.FindNodeByFieldValue("NameLevel2", "NameLevel3")
    End Sub


   
    Private Sub Button1_Click(sender As Object, e As EventArgs)
        'If txt_NameAccount2.Text = "" Then Exit Sub
        'Dim newnode As New TreeNode
        'newnode.Text = txt_NameAccount1.Text
        'AddNode(trvTree.Nodes(0), newnode)

        'newParent = New TreeNode("Plot patterns")
        'newRootNode.Nodes.Add(newParent)
        'Dim newChild As TreeNode
        'newChild = New TreeNode(txt_NameAccount1.Text)
        'TreeView1.Nodes.Add(txt_NameAccount2.Text)

        'Dim plot1 As TreeNode = New TreeNode
        'TreeView1.Nodes.Add("plot1", "Plot E-plane")
        'Dim save As TreeNode = New TreeNode
        'TreeView1.Nodes.Add("save", "Save patterns", "tvropen")
    End Sub
End Class