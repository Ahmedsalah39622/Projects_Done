...
Public Class Condation_Order
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Condation_Order.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCondation_Order
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Condation_Order = New Condation_Order()
        rpt.Site = Me.Site
        Return rpt
    End Function
