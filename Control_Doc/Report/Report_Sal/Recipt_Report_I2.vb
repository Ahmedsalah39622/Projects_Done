...
Public Class Recipt_Report_I2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Recipt_Report_I2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecipt_Report_I2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Recipt_Report_I2 = New Recipt_Report_I2()
        rpt.Site = Me.Site
        Return rpt
    End Function
