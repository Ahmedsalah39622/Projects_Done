...
Public Class Order_ItemStores_F
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Order_ItemStores_F.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrder_ItemStores_F
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Order_ItemStores_F = New Order_ItemStores_F()
        rpt.Site = Me.Site
        Return rpt
    End Function
