...
Public Class InvintoryValue3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.InvintoryValue3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvintoryValue3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvintoryValue3 = New InvintoryValue3()
        rpt.Site = Me.Site
        Return rpt
    End Function
