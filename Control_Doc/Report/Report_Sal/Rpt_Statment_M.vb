...
Public Class Rpt_Statment_M
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Doc.Rpt_Statment_M.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Statment_M
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Statment_M = New Rpt_Statment_M()
        rpt.Site = Me.Site
        Return rpt
    End Function
